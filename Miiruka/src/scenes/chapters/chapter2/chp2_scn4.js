...
export class Chp2_scn4 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('entrada_bomba', 'assets/juegos/meter_varilla/entrada_bomba.png');
        this.load.image('varilla_nueva', 'assets/juegos/meter_varilla/varilla_nueva.png');
        this.load.image('varilla_doblada', 'assets/juegos/meter_varilla/varilla_doblada.png');
    ...
    create() {
        ...
        this.time.delayedCall(0, async () => {
            this.placeMill();
            await this.storyRunner.run('Varilla');
        });
    }
    ...
    placeMill() {
        ...
        console.debug('placeMill chp2_scn4', { scrollY: cam.scrollY, camHeight: cam.height, worldBottom: cam.worldView?.bottom, baseBottom, baseY });
